...
export const cssLessons = {
  introduction: {
    title: "מה זה CSS?",
    intro: [
      "HTML מתאר מה נמצא בדף; CSS קובעת איך התוכן נראה ומסתדר. בעזרתה שולטים בצבעים, ריווח, גודל טקסט, פריסה והתאמה למסכים שונים.",
      "CSS אינה מחליפה מבנה HTML נכון. מתחילים ממסמך ברור ונגיש, ואז מוסיפים שכבת עיצוב שאפשר לשנות בלי לכתוב מחדש את התוכן.",
    ],
    sections: [
      { title: "כלל CSS ראשון", paragraphs: ["כלל מורכב מ־selector שבוחר אלמנטים ומבלוק של declarations. בכל declaration יש property, נקודתיים, value ונקודה־פסיק."], code: `h1 {\n  color: #0f766e;\n  font-size: 2rem;\n}`, language: "css" },
      { title: "חיבור קובץ עיצוב", paragraphs: ["מקובל לשמור CSS בקובץ נפרד ולטעון אותו מתוך head. כך כמה עמודים יכולים להשתמש באותו עיצוב וה־HTML נשאר קריא."], code: `/* styles.css */\nbody {\n  background-color: #f8fafc;\n  color: #1e293b;\n}\n\n/* בתוך <head> */\n/* <link rel="stylesheet" href="styles.css"> */`, language: "css", exercise: { id: "css-introduction-fill-property-1", type: "fill_blank", prompt: "איזה מאפיין משנה את צבע הטקסט?", code: `p {\n  ___: #334155;\n}`, language: "css", options: [{ id: "color", label: "color" }, { id: "background", label: "background" }, { id: "width", label: "width" }], correctOptionId: "color", hint: "שם המאפיין מתאר ישירות את צבע התוכן.", explanation: "color משנה את צבע הטקסט. background משנה את הרקע ו־width את הרוחב." } },
    ],
  ...
  "box-model": {
    ...
    sections: [
      { title: "ריווח פנימי וחיצוני", paragraphs: ["אפשר לתת ערך לכל הצדדים, לציר אנכי ואופקי, או לכל צד בנפרד. שמות לוגיים כמו inline ו־block עובדים טוב גם בכיוון כתיבה RTL."], code: `.card {\n  padding: 1rem 1.25rem;\n  margin-block: 1.5rem;\n  border: 1px solid #cbd5e1;\n}`, language: "css" },
      { title: "box-sizing צפוי", paragraphs: ["ברירת המחדל מוסיפה padding ו־border לרוחב שהגדרנו. border-box כולל אותם בתוך width ולכן מקל מאוד על חישוב פריסות."], code: `*,\n*::before,\n*::after {\n  box-sizing: border-box;\n}\n\n.panel {\n  width: 100%;\n  padding: 24px;\n}`, language: "css", exercise: { id: "css-box-model-fill-padding-1", type: "fill_blank", prompt: "איזה מאפיין יוצר רווח בין התוכן למסגרת?", code: `.button {\n  ___: 0.75rem 1rem;\n  border: 1px solid teal;\n}`, language: "css", options: [{ id: "padding", label: "padding" }, { id: "margin", label: "margin" }, { id: "gap", label: "gap" }], correctOptionId: "padding", hint: "הרווח המבוקש נמצא בתוך הקופסה.", explanation: "padding יוצר ריווח פנימי בין התוכן ל־border. margin נמצא מחוץ לקופסה." } },
    ],
  ...
  typography: {
    ...
    sections: [
      ...
      { title: "אורך שורה ויישור", paragraphs: ["שורות ארוכות מדי קשות למעקב. max-inline-size מגבילה את רוחב הטקסט בלי לקבוע רוחב קשיח, ו־text-align: start מכבד גם RTL וגם LTR."], code: `.article {\n  max-inline-size: 65ch;\n  margin-inline: auto;\n}\n\np { text-align: start; }`, language: "css", exercise: { id: "css-typography-fill-line-height-1", type: "fill_blank", prompt: "איזה מאפיין מגדיל את המרווח בין שורות טקסט?", code: `p {\n  ___: 1.7;\n}`, language: "css", options: [{ id: "line-height", label: "line-height" }, { id: "letter-spacing", label: "letter-spacing" }, { id: "font-weight", label: "font-weight" }], correctOptionId: "line-height", hint: "המאפיין מתייחס לגובה של כל שורה.", explanation: "line-height קובעת את גובה השורה וכך את המרווח האנכי בין שורות סמוכות." } },
    ],
  ...
  "units-sizing": {
    ...
    intro: ["יחידה קובעת למה המספר מתייחס. px מתאימה לפרטים קטנים ומדויקים, rem קשורה לגודל הטקסט הראשי, אחוזים קשורים להורה ו־vw או vh קשורות למסך.", "עיצוב רספונסיבי מעדיף גבולות גמישים על מספרים קשיחים. width: 100% עם max-width מאפשרת לרכיב להתכווץ במסך קטן בלי להימתח מדי במסך רחב."],
    sections: [
  ...
  "display-positioning": {
    ...
    intro: ["display קובעת כיצד אלמנט משתתף בפריסה. block תופס שורה, inline זורם בתוך טקסט, ו־inline-block משלב זרימה בשורה עם אפשרות לתת גודל וריווח מלאים.", "position מוציאה רכיב חלקית מהזרימה הרגילה. משתמשים בה כשיש קשר מיקום אמיתי—למשל תגית על כרטיס—ולא כדי לתקן פריסה שאמורה להיבנות ב־Flexbox או Grid."],
    sections: [
  ...
  flexbox: {
    ...
    intro: ["Flexbox מסדרת פריטים לאורך ציר מרכזי אחד—שורה או עמודה. היא מצוינת לניווט, קבוצת כפתורים, כרטיס עם אייקון וטקסט או יישור אנכי.", "ההורה הופך ל־flex container והילדים הישירים הופכים לפריטי flex. רוב החלטות הפריסה, כמו כיוון, רווח ויישור, נכתבות על ההורה."],
    sections: [
      { title: "Main axis ו־cross axis", paragraphs: ["justify-content פועלת לאורך ה־main axis ו־align-items לאורך ה־cross axis. המאפיין gap מוסיף רווח רק בין הפריטים ונוח יותר מ־margin על כל ילד."], code: `.actions {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  gap: 1rem;\n}`, language: "css" },
      { title: "Wrapping וגמישות", paragraphs: ["flex-wrap מאפשרת לפריטים לעבור שורה. flex: 1 1 16rem אומר שכרטיס יכול לגדול, להתכווץ ומתחיל מ־flex-basis של 16rem."], code: `.cards {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 1rem;\n}\n.cards > article { flex: 1 1 16rem; }`, language: "css", exercise: { id: "css-flexbox-fill-gap-1", type: "fill_blank", prompt: "איזה property יוצר רווח אחיד בין פריטי Flexbox?", code: `.toolbar {\n  display: flex;\n  ___: 0.75rem;\n}`, language: "css", options: [{ id: "gap", label: "gap" }, { id: "padding", label: "padding" }, { id: "border", label: "border" }], correctOptionId: "gap", hint: "ה־property עובד בין פריטי הפריסה.", explanation: "gap יוצר רווח בין הילדים בלי להוסיף רווח בקצוות החיצוניים של ה־container." } },
    ],
    next: { title: "CSS Grid", path: "/tutorials/css/grid" },
  },
  grid: {
    title: "פריסה עם CSS Grid",
    intro: ["Grid מתאימה לפריסה בשני צירים: שורות ועמודות יחד. היא שימושית לגלריה, לוח נתונים או מבנה עמוד שבו אזורים צריכים להתיישר זה מול זה.", "אין תחרות בין Grid ל־Flexbox. Grid מצוינת למבנה הרחב; Flexbox מצוינת ליישור תוכן בתוך כל אזור. לעיתים משתמשים בשתיהן באותו רכיב."],
    sections: [
    ...
    next: { title: "עיצוב רספונסיבי", path: "/tutorials/css/responsive-design" },
  },
  "responsive-design": {
  ...
  "transitions-animation": {
    ...
    sections: [
      { title: "Transition ממוקדת", paragraphs: ["מגדירים רק את המאפיינים שצריכים להשתנות, במקום transition: all. transform ו־opacity בדרך כלל חלקים יותר ממאפיינים שמשנים פריסה."], code: `.button {\n  transition: transform 160ms ease, background-color 160ms ease;\n}\n.button:hover {\n  transform: translateY(-2px);\n  background-color: #115e59;\n}`, language: "css" },
      { title: "כיבוד העדפת תנועה", paragraphs: ["חלק מהמשתמשים מבקשים במערכת פחות תנועה. media query של prefers-reduced-motion מאפשרת לבטל או לצמצם אנימציות עבורם."], code: `@media (prefers-reduced-motion: reduce) {\n  *, *::before, *::after {\n    scroll-behavior: auto !important;\n    animation-duration: 0.01ms !important;\n    transition-duration: 0.01ms !important;\n  }\n}`, language: "css", exercise: { id: "css-motion-fill-transition-1", type: "fill_blank", prompt: "איזה מאפיין מחליק את שינוי הצבע בין מצבים?", code: `.button {\n  ___: background-color 160ms ease;\n}`, language: "css", options: [{ id: "transition", label: "transition" }, { id: "transform", label: "transform" }, { id: "animation-name", label: "animation-name" }], correctOptionId: "transition", hint: "מדובר במעבר בין ערך רגיל לערך hover.", explanation: "transition מגדירה איזה מאפיין ישתנה, כמה זמן יימשך המעבר ובאיזה קצב." } },
    ],
    next: { title: "ארגון CSS", path: "/tutorials/css/organization" },
  },
  organization: {
    title: "ארגון CSS ורכיבים",
    ...
    sections: [
      { title: "רכיב עם וריאציה", paragraphs: ["מחלקת בסיס מחזיקה את כללי הרכיב, ומחלקת modifier מוסיפה רק את ההבדל. כך אין צורך להעתיק padding, radius וטיפוגרפיה לכל סוג כפתור."], code: `.button {\n  padding: 0.75rem 1rem;\n  border-radius: 0.5rem;\n  font: inherit;\n}\n.button--primary { background: teal; color: white; }\n.button--quiet { background: transparent; color: teal; }`, language: "css" },
    ...
    next: { title: "דף רספונסיבי ונגיש", path: "/tutorials/css/accessible-page" },
  },
  "accessible-page": {
    title: "בונים דף רספונסיבי ונגיש",
    intro: ["עיצוב איכותי מחבר את כל העקרונות: קסקדה צפויה, טיפוגרפיה קריאה, פריסה גמישה, מצבי מיקוד ותנועה מכבדת. המטרה אינה להציג כמה שיותר מאפיינים, אלא ליצור ממשק רגוע שעובד במצבים שונים.", "לפני פרסום בדקו מסך צר ורחב, הגדלת טקסט, ניווט מקלדת וניגודיות. ודאו שאין גלילה אופקית ושמידע חשוב אינו תלוי רק בצבע, hover או אנימציה."],
    sections: [
      ...
      { title: "בדיקת מצבים", paragraphs: ["כפתור צריך להישאר ברור במצב רגיל, hover, focus ו־disabled. טבעת המיקוד נמצאת מחוץ לרכיב ולכן אינה משנה את הפריסה."], code: `.card a { color: var(--primary); }\n.card a:focus-visible {\n  outline: 3px solid #22d3ee;\n  outline-offset: 3px;\n}\n@media (prefers-reduced-motion: no-preference) {\n  .card { transition: transform 160ms ease; }\n  .card:hover { transform: translateY(-2px); }\n}`, language: "css", exercise: { id: "css-accessible-page-predict-priority-1", type: "predict_output", prompt: "איזו בדיקה חשובה לפני פרסום עמוד רספונסיבי?", code: `/* בחרו את הבדיקה שנותנת את הכיסוי הרחב ביותר */`, language: "css", options: [{ id: "all", label: "מסך צר, הגדלת טקסט וניווט מקלדת" }, { id: "desktop", label: "רק מסך מחשב רחב" }, { id: "color", label: "רק הצבע הראשי" }], correctOptionId: "all", hint: "עיצוב טוב צריך להמשיך לעבוד עם מכשיר ושיטת ניווט שונים.", explanation: "שילוב של מסך צר, הגדלת טקסט ומקלדת חושף בעיות פריסה ונגישות שלא רואים בבדיקת מחשב רגילה בלבד." } },

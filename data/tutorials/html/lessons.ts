  ...
  introduction: {
    ...
    sections: [
      ...
      },
      {
        ...
        exercises: [
          {
            id: "html-introduction-select-semantic-1",
            type: "select_multiple",
            prompt: "אילו אלמנטים מתארים תפקיד ברור בתוכן?",
            code: `<main>תוכן מרכזי</main>\n<button>שמירה</button>\n<div>אזור</div>\n<span>טקסט</span>`,
            language: "html",
            options: [
              { id: "main", label: "<main>" },
            ...
            correctOptionIds: ["main", "button"],
            hint: "חפשו שמות שמספרים מה התוכן עושה, לא רק עוטפים אותו.",
            explanation: "main ו־button מבטאים משמעות ותפקיד. div ו־span הם containers כלליים ללא משמעות מובנית.",
          },
          {
            id: "html-introduction-match-elements-1",
            type: "match_pairs",
            prompt: "התאימו כל אלמנט לתפקיד העיקרי שלו.",
            leftItems: [
              { id: "h1", label: "<h1>" },
              { id: "p", label: "<p>" },
              { id: "a", label: "<a>" },
            ...
            rightItems: [
              { id: "link", label: "קישור" },
              { id: "heading", label: "כותרת ראשית" },
              { id: "paragraph", label: "פסקה" },
            ],
            correctMatches: ["h1:heading", "p:paragraph", "a:link"],
            hint: "חשבו מה הדפדפן וקורא המסך מבינים מכל tag.",
            explanation: "h1 היא הכותרת הראשית, p מייצגת פסקה ו־a יוצרת קישור ליעד.",
          },
        ],
      },
    ],
